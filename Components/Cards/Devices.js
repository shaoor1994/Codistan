...
const CreateCard = () => {
    ...
    return(
         <View style={{margin:45,alignSelf:'center',marginTop:35,marginBottom:-10}} >
      ...
      <View>
        ...
        <Paragraph style={Styles.text}>Amet Minimi mollit deserunt unillamco est sit amet</Paragraph>
